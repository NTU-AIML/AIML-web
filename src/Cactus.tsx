...
function Cactus(){
    ...
    return <div style={{display:"flex", flexDirection:"column", padding:"0px", margin:"0px"}}>
        ...
        <Bar backgroundColor="rgb(217, 217, 217)" imgPath="/cactus.jpg" swapPos={true} height="auto">
            ...
            <p style={{fontSize:"1.4em", textAlign:"center", padding:"10px"}}>
                We provide everything you need: expert guidance, training, and computing resources. Whether you're driven to excel in AI or eager to take your skills to the next level, CACTUS is your pathway to success.
            </p>
        </Bar>
        ...
        <div style={{margin:"20px"}}>
            <h1 style={{textAlign:"center", wordBreak:"break-word", fontWeight:"bold", fontSize:"2em"}}>What We Offer</h1>

            <div style={{display:"flex", flexDirection:"row", overflow:"scroll", margin:"", justifyContent:"center"}}>
                
                
                <Card style={{backgroundColor:"#dadada", width:"max(25%,200px)", margin:"10px"}}>
                    <CardContent>
                        <h1 style={{color:"#304b5b", textAlign:"center", fontWeight:"bold", fontSize:"1.6em"}}>Expert Training</h1>
                        <div style={{display:"flex", flexDirection:"row", justifyContent:"center", height:"100px", margin:"10px"}}>
                        ...
                        <p style={{fontSize:"1.2em", textAlign:"center"}}>
                            Gain a competitive edge with guidance from professors and industry professionals, tailored specifically for excelling in AI competitions.
                        </p>
                    </CardContent>
                </Card>
        ...
        <Bar backgroundColor="rgb(255, 255, 255)" imgPath="/cactus2.jpg" style={{padding:"40px", height:"30px"}}>
            ...
            <Link to="https://forms.office.com/r/uY83afE3W3" style={{textDecoration:"none", color:"white", display:"flex", justifyContent:"center", margin:"10px"}}>
                <Button style={{background:"#304b5b", borderRadius:"10px", padding:"25px", height:"fit-content"}}>
                        ...
                        <div>
                            <p style={{textAlign:"center", fontSize:"1.5em", fontWeight:"bold", textWrap:"wrap"}}>Register as a Team Leader!</p>
                        </div>
                </Button>
            </Link>
