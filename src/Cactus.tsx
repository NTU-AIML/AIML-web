    ...
    >
      ...
      <h1
        style={{
          ...
          background: `url(${process.env.PUBLIC_URL}/background.jpg) center/cover`,
        }}
      >
        CACTUS
      </h1>
      ...
      >
        ...
        >
          <b>CCDS AI Competition Team for Undergraduate Student</b> (CACTUS)
          is a program designed to help students succeed in AI competitions.
        </p>
        <p
          style={{
            fontSize: "1.2em",
      ...
      <div style={{ margin: "20px", padding: "0 5%" }}>
        <h1
          style={{
            textAlign: "center",
            wordBreak: "break-word",
        ...
        >
          ...
          >
            <CardContent>
              ...
              >
                Gain a competitive edge with guidance from professors and industry
                professionals, tailored specifically for excelling in AI competitions.
              </p>
            </CardContent>
          </Card>
      ...
      >
        ...
        {/* Using aspect-ratio for a 16:9 video */}
        <div
          style={{
            width: "90%",
            maxWidth: "800px",
        ...
        >
          <video
            controls
            src="/cactus_promotion_video.MP4"
            style={{
              position: "absolute",
              top: 0,
              left: 0,
      ...
      <Bar
        ...
        imgPath="/cactus2.jpg"
        style={{ padding: "40px", height: "auto" }}
      >
        <h1
          style={{
            textAlign: "center",
        ...
        >
          ...
          <p>
            We’re looking for experienced and competent{" "}
            <b>Team Leaders</b> to spearhead teams in AI competitions. As a Team
